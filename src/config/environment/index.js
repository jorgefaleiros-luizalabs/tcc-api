...
let all = {
  ...
  useNewRelic: process.env.USE_NEWRELIC === 'true',

  tokenNewRelic: process.env.TOKEN_NEWRELIC,

  log: {
    burzum: {
      token: process.env.BURZUM_TOKEN ? process.env.BURZUM_TOKEN : '',
