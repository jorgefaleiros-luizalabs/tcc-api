    ...
    describe('when user is authenticated', () => {
      it('return 200 HTTP status code', (done) => {
        ...
        server.inject(options, (response) => {
          ...
          expect(body.records[0]).to.have.property('name', 'DENIS WILLIAM DE FREITAS SOUZA');
          done();
        });
      });
      ...
      it('return 200 HTTP status code with offset', (done) => {
        ...
        server.inject(options, (response) => {
          ...
          expect(body.records[0]).to.have.property('name', 'User 3');
          done();
        });
      });
    ...
    describe('when user is authenticated', () => {
      ...
      it('return 201 HTTP status code when all data is correct', (done) => {
        let options = {
          ...
          payload: {
            name: 'DENIS WILLIAM DE FREITAS SOUZA MTG'
          }
        };
        server.inject(options, (response) => {
          let body = response.result;
          ...
          expect(body.records[0]).to.have.property('name', 'DENIS WILLIAM DE FREITAS SOUZA MTG');
          done();
        });
      });
    });
    ...
    describe('when user is authenticated', () => {
      ...
      it('return 200 HTTP status code when all data is correct', (done) => {
        let options = {
          ...
          payload: {
            name: 'DENIS WILLIAM DE FREITAS SOUZA NEW'
          }
        };
        server.inject(options, (response) => {
          let body = response.result;
          ...
          expect(body.meta.recordCount).to.have.least(1);
          expect(body.records[0]).to.have.property('id');
          expect(body.records[0]).to.have.property('name', 'DENIS WILLIAM DE FREITAS SOUZA NEW');
          done();
        });
      });
    });
